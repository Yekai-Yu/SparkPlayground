...
def foreach_batch_function(df, epoch_id):
    ...
    get_dynamodb().Table(q3_2_table_name).put_item(
        Item = { 'origin-tran-dest-date': str(q3dot2_df1['Origin 1']) + "-" + str(q3dot2_df1['Destination 1'] + "-" + str(q3dot2_df1["Destination 2"]) + "-" + str(q3dot2_df1["Sched Depart 1"]) + "-" + str(q3dot2_df1["Sched Depart 2"])), 
